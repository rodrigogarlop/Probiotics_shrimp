...
# Internally: 
# df <- as.matrix(read.table("/home/rod/Documents/02_Collaborations/Prebioticos_Pablo/03_corr_tables/prebiotics_lvlOTU-H_grp_2-corr_pearson_rows_maxpval_0.01.tsv", sep="\t",header=T, skip=0, comment.char='',quote="",fill=F, row.names=1, check.names=F))
